      ...
      <main className=" py-6 px-9 max-sm:px-6 rounded-lg w-[90%] md:w-[40%] lg:w-[35%] bg-gray-800">
        ...
        <form action="" onSubmit={handleSearchCountry}>
          <div className="flex justify-between items-center gap-3">
            <input
              type="text"
              className="bg-slate-600 py-3 px-3 text-bold text-white w-full rounded-full focus:shadow-lg outline-gray-950 font-medium border-0"
        ...
        <div className="my-6">
          <div className="grid max-sm:grid-cols-2 grid-cols-1 gap-2 my-2">
            <div className="py-3 px-3 rounded-md  bg-slate-600">
